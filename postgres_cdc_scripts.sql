...
BEGIN
    change_details := '{}'::JSONB; -- Initialize an empty JSONB as a new structure inside of main json

    -- Check each column for changes and record as necessary and check what was changed what type
